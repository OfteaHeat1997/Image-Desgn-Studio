    ...
    try {
      ...
      if (selectedProvider === "browser") {
        ...
        const blob = await removeBackground(imageFile, {
          // publicPath is required in Next.js production: the bundled JS runs from
          // /_next/static/chunks/ where the WASM/model files don't exist.
          // Pointing to the CDN ensures the assets are always found.
        ...
        // Prefer the already-uploaded Replicate URL (public HTTP) to avoid
        // re-uploading the data URL inside the bg-remove server route.
        const imageUrlForApi = uploadData.data.replicateUrl ?? uploadData.data.url;
