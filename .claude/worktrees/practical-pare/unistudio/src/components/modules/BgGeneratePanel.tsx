...
const STYLE_PRESETS: StylePreset[] = [
  ...
  // Moda Íntima (API)
  { id: "lingerie-boudoir", name: "Boudoir", category: "Moda Íntima", description: "Escena boudoir romantica con petalos" },
  { id: "lingerie-silk", name: "Saten", category: "Moda Íntima", description: "Fondo de saten champagne elegante" },
  { id: "lingerie-vanity", name: "Tocador", category: "Moda Íntima", description: "Tocador femenino con espejo y rosas" },
  // Fragancias (API)
  { id: "fragrance-mirror", name: "Espejo Negro", category: "Fragancias", description: "Superficie reflectiva negra de lujo" },
  { id: "fragrance-garden", name: "Jardin Brumoso", category: "Fragancias", description: "Jardin al amanecer con neblina dorada" },
  { id: "fragrance-crystal", name: "Cristal", category: "Fragancias", description: "Prismas de cristal con efectos de luz" },
  // Joyería (API)
  { id: "jewelry-velvet-tray", name: "Bandeja", category: "Joyería", description: "Bandeja de terciopelo azul profesional" },
  { id: "jewelry-dark-stone", name: "Granito", category: "Joyería", description: "Superficie de granito oscuro pulido" },
  { id: "jewelry-botanical", name: "Botanico", category: "Joyería", description: "Marmol blanco con flores y eucalipto" },
  // Skincare (API)
  { id: "skincare-flatlay", name: "Flatlay", category: "Skincare", description: "Lino con eucalipto y piedras naturales" },
  { id: "skincare-terrazzo", name: "Terrazzo", category: "Skincare", description: "Superficie terrazzo rosa pastel moderno" },
];
