      ...
      body: JSON.stringify({
        ...
        messages: [{
          ...
          content: [
            ...
            { type: 'text', text: `Compare IMAGE 2 to the real ${noun} in IMAGE 1, looking FIRST at the FRONT CLOSURE at the center of the chest.${hint ? ' The real construction is: ' + hint + '.' : ''} IMAGE 2 PASSES only if ALL of these are true: (a) THE FRONT CLOSURE MATCHES EXACTLY — if IMAGE 1 shows a visible vertical column of hook-and-eye clasps (or a zipper, or buttons) down the center front, IMAGE 2 MUST clearly show that SAME closure in the same place; a smooth/plain/seamless front with NO visible closure is an automatic FAIL; (b) same strap width and style, same mesh/panel layout, same cut and silhouette; (c) the fabric looks like REAL photographed cloth with natural satin sheen — NOT plastic, rubbery, cartoonish, CGI or doll-like; (d) ONE single front product — NOT two mannequins, NOT a front+back collage; (e) NO visible human person, face or skin. Answer ONLY "yes" if ALL of (a)(b)(c)(d)(e) pass, or "no" if ANY one fails.` },
          ],
        }],
      }),
    });
