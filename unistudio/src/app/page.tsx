  ...
  return (
    <Link href={mod.href} className="group block">
      ...
      >
        ...
        {/* Content */}
        <div className="p-4">
          <h3 className="text-sm font-bold text-heading mb-0.5">{mod.name}</h3>
          <p className="text-xs font-medium mb-2" style={{ color: "var(--accent-muted)" }}>{mod.tagline}</p>

          <p className="text-xs leading-relaxed text-body mb-3">
            {mod.description}
          </p>

          {/* Prerequisite hint */}
          {mod.prerequisite && (
            <div className="flex items-start gap-2 rounded-lg mb-3 px-2.5 py-1.5"
              style={{ background: "rgba(255,180,50,0.05)", border: "1px solid rgba(255,180,50,0.1)" }}
            >
              <ArrowRight className="h-3 w-3 mt-0.5 shrink-0" style={{ color: "rgba(255,180,50,0.5)" }} />
              <span className="text-[11px] leading-relaxed" style={{ color: "rgba(255,200,100,0.6)" }}>
                {mod.prerequisite}
              </span>
            </div>
          )}
          ...
          {/* CTA */}
          <div
            className="flex items-center text-xs font-semibold tracking-wide uppercase transition-colors duration-300"
            style={{ color: isHovered ? "var(--accent)" : "var(--text-muted)" }}
          >
            Usar herramienta
...
const CATEGORY_COLORS: Record<string, string> = {
  "Paso 1 — Prepara tu Foto": "#50C878",
  "Paso 2 — Crea el Escenario": "#C5A47E",
  "Paso 3 — Modelos y Prueba Virtual": "#F5A623",
  "Paso 4 — Contenido para Redes": "#5B9CF6",
  "Paso 5 — Automatiza y Publica": "#A78BFA",
};
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-0">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:px-14 md:py-20 lg:py-24">
          ...
          <div className="flex items-center gap-3.5 mb-10">
            ...
            <div>
              <span className="text-xl font-bold tracking-tight text-heading">UniStudio</span>
              <div className="h-[1px] w-full mt-0.5" style={{ background: "linear-gradient(90deg, var(--accent), transparent)" }} />
            </div>
          </div>

          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] tracking-tight text-heading mb-5">
            Tu estudio de
            <br />
            fotografia
            <br />
          ...
          <p className="text-sm leading-relaxed text-body mb-10 max-w-md">
          ...
          <div className="flex flex-wrap gap-3 mb-12">
            <Link href="/editor?module=bg-remove"
              className="inline-flex items-center gap-2.5 rounded-[11px] px-6 py-3.5 text-sm font-semibold text-surface transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
              style={{
            ...
            <Link href="/editor?module=ai-prompt"
              className="inline-flex items-center gap-2.5 rounded-[11px] px-6 py-3.5 text-sm font-semibold text-accent transition-all duration-300 hover:-translate-y-0.5"
              style={{
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <React.Fragment key={s.label}>
                ...
                <div>
                  <div className="text-lg font-bold text-accent leading-none mb-1">{s.value}</div>
                  <div className="text-xs text-muted uppercase tracking-wider font-medium">{s.label}</div>
                </div>
              </React.Fragment>
            ))}
          </div>
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between">
                <div>
                  ...
                  <span className="text-xs text-white/60">{stage.description}</span>
                </div>
                {stage.badge && (
            ...
            <div className="mt-5 flex items-center justify-center gap-2">
              {SHOWCASE_STAGES.map((s, i) => (
                ...
                >
                  ...
                  />
                  {i === activeStage && (
                    <span className="text-xs font-medium" style={{ color: "var(--accent)" }}>{s.label}</span>
                  )}
                </button>
              ))}
            </div>
      ...
      <div className="mx-auto max-w-[1320px] px-6 py-10 md:px-10 md:py-14">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <h2 className="text-lg font-bold text-heading">AI Automatico</h2>
        ...
        <section className="mb-24 grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-heading mb-1">Workflows Visuales</h3>
              <p className="text-xs text-muted leading-relaxed">Ve como se conectan todos los modulos en un mapa visual interactivo estilo Weavy</p>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-heading mb-1">Mapa del Proyecto</h3>
              <p className="text-xs text-muted leading-relaxed">Cada archivo, cada carpeta — que hace y donde ir para cambiarlo. Documentacion interactiva.</p>
            </div>
            <ArrowRight className="h-5 w-5 text-muted group-hover:text-accent transition-all duration-300 group-hover:translate-x-1" />
          </Link>
        </section>
        ...
        <section>
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-heading mb-2">Herramientas</h2>
            <p className="text-sm text-muted leading-relaxed">18 herramientas de IA — desde la foto cruda hasta contenido listo para vender</p>
          </div>
              ...
              <div key={category} className="mb-14">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-1.5">
                    ...
                    <h3 className="text-base font-bold text-heading">{category}</h3>
                    <div className="flex-1 h-px" style={{ background: `${catColor}18` }} />
                  </div>
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-xl font-bold text-heading mb-3">Listo para transformar tus fotos?</h2>
            ...
            <Link href="/editor?module=bg-remove"
              className="inline-flex items-center gap-3 rounded-xl px-8 py-4 text-sm font-semibold text-surface transition-all duration-300 hover:-translate-y-0.5"
              style={{
                background: "linear-gradient(135deg, var(--accent), var(--accent-light))",
